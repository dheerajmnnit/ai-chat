...
export default function Form() {
    ...
    const onSubmit = async data => {
        if (data.prompt !== "") {
            ...
            toast({
                title: "Successful! Please give Soul a moment.",
                status: 'success',
                isClosable: true,
            })
        } else {
                ...
                >
                    <GridItem mt={[5, null, 0]} colSpan={{ md: 1 }}>
                        <Box px={[4, 0]}>
                            ...
                            >
                                Check out your past conversations with Soul.
                            </Text>
                        </Box>
                        ...
                        >
                            ...
                            >
                                ...
                                <FormControl id="prompt" mt={1}>
                                    ...
                                    >
                                        Chat with Soul, your personal AI!
                                    </FormLabel>
                                    <Textarea
                                    ...
                                    />
                                    <FormHelperText>
                                        Example prompt: Write about the use cases for getting better job.
                                    </FormHelperText>
                                </FormControl>
